...
std::string format_system_prompt(const std::string & system_prompt, std::vector<common_chat_msg> & chat_msgs,
    ...
    return common_chat_format_single(chat_templates.get(), chat_msgs, msg, false, use_jinja);
}
